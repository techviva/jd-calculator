...
import {
    DialogBody, DialogContent, DialogHeader, DialogTrigger, DialogRoot,
    DialogTitle,
    DialogFooter
} from "./dialog"
import { Button } from "./button"
import {
    Field, HStack, Input, Textarea, VStack,
    useDisclosure, Button as DefaultButton
...
export function CreateProjectModal({
    ...
    const { open: isDeleteConfirmOpen, onOpen: onDeleteConfirmOpen, onClose: onDeleteConfirmClose, setOpen: onDeleteSetOpen } = useDisclosure()
            ...
            >
                <DialogContent borderRadius="xl">
                    ...
                    <DialogFooter justifyContent="space-between">
                        <DefaultButton ref={cancelRef} onClick={onDeleteConfirmClose} fontSize="small" borderRadius={10}
                            size="lg"
                            colorPalette="gray">
                            Cancel
                        </DefaultButton>
